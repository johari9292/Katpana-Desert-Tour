...
export const tourPackages: TourPackage[] = [
  {
    ...
    region: "Skardu, Katpana Desert, Kachura and Shigar",
    difficulty: "Easy",
    ...
    destinationOverview:
      "Skardu sits between the Indus River, glacial lakes, desert dunes, and the gateway valleys of the Karakoram. Katpana Desert is close to the airport and city, which makes it ideal for sunrise, sunset, and first-day sightseeing.",
    activities: [
      "Cold desert sunset",
      "Lake viewpoints",
      "Heritage fort visit",
    ...
    highlights: [
      "Golden-hour photography at Katpana Desert and Katpana Lake",
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival in Skardu and Katpana sunset",
        body: "Meet at Skardu Airport, transfer to hotel, rest after the mountain flight, then visit Katpana Desert for dunes, lake views, and sunset photography.",
      },
      {
        day: "Day 2",
  ...
  },
  {
    ...
    itinerary: [
      ...
      {
        day: "Day 2",
        title: "Katpana and Kachura acclimatization",
        body: "Keep the first full day lower in elevation with Katpana Desert, Shangrila, Upper Kachura, and early rest for the next day's long drive.",
      },
      {
        day: "Day 3",
    ...
    excluded: [
      ...
      "Meals and snacks",
      "Flights",
      "Guide for specialist wildlife work",
      "Personal gear",
    ],
    keywords: [
  ...
  },
  {
    ...
    highlights: [
      "Katpana Desert, Kachura lakes, Shigar Fort, and Khaplu Palace route options",
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrive in Skardu",
        body: "Airport transfer, hotel check-in, and Katpana Desert sunset if timing and weather are favorable.",
      },
      {
        day: "Day 2",
    ...
    included: [
      "Private vehicle",
      "Driver and fuel plan",
      "Hotel booking assistance",
      "Airport or road transfer support",
      "Custom day order",
    ],
    excluded: [
      "Domestic flights",
  ...
  },
  {
    ...
    included: [
      "Licensed guide coordination",
      "Porter and camp planning",
      "Jeep transfer planning",
      "Permit guidance",
      "Pre-trek hotel support",
    ],
    excluded: [
  ...
  },
  {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival and Katpana Desert",
        body: "Land in Skardu, settle into the hotel, and visit Katpana Desert for an easy first evening.",
      },
      {
        day: "Day 2",
    ...
    excluded: [
      "Meals",
      "Heritage entry tickets",
      "Flights",
      "Personal shopping",
      "Professional guide unless requested",
    ],
    keywords: [
      "Khaplu Palace tour",
      "Shigar Fort",
  ...
  },
  {
    ...
    highlights: [
      "Skardu acclimatization with Katpana and Kachura before the longer route",
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrive in Skardu",
        body: "Airport pickup, hotel check-in, and an easy Katpana Desert or city viewpoint visit.",
      },
      {
        day: "Day 2",
  ...
  },
  {
    ...
    metaDescription:
      "K2 base camp trek packages from Skardu with permits, porters, Askole jeeps, camps and buffers. Plan now.",
    canonicalPath: "/tours/k2-trek-packages",
    schemaType: "TouristTrip",
    imageAlt:
      "K2 base camp trek packages on Baltoro Glacier Karakoram Pakistan",
    ...
    included: [
      "Local trek planning",
      "Guide and porter coordination guidance",
      "Askole jeep planning",
      "Permit guidance",
      "Pre-trek Skardu hotel support",
    ],
    excluded: [
      "Flights",
      "Personal gear",
  ...
  },
  {
    ...
    difficulty: "Moderate",
    bestSeason:
      "June to September for high routes, April to October for lower valleys",
    ...
    metaDescription:
      "Skardu jeep safari guide for Deosai, Basho, Shigar, Satpara and cold desert 4x4 routes. Book now.",
    canonicalPath: "/tours/jeep-safari-skardu",
    schemaType: "TouristTrip",
    imageAlt:
      "Skardu jeep safari guide across Deosai National Park plateau Pakistan",
    imageTitle:
      "Skardu jeep safari guide for Deosai Basho and cold desert routes",
    overview:
    ...
    included: [
      ...
      "Airport and hotel pickup planning",
...
export function getRelatedTours(tour: TourPackage, limit = 3) {
  return tourPackages
    .filter(
      (item) => item.slug !== tour.slug && item.category !== tour.category,
    )
    .slice(0, limit);
}
