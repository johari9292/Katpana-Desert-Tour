...
export const destinations: Destination[] = [
  {
    ...
    highlights: [
      "Sunrise and sunset dunes",
      "Katpana Lake",
      "Snow desert views in winter",
      "Easy first-day sightseeing",
    ],
    activities: [
      "Photography",
      "Short walks",
      "Family sightseeing",
      "Desert-view hotel stays",
    ],
    idealFor: ["Families", "Couples", "First-time visitors", "Photographers"],
    travelNote:
      "Arrive before golden hour and keep warm layers ready because the wind can feel cold even when the day is clear.",
    keywords: [
      "Katpana Desert",
      "Skardu cold desert",
      "Katpana Desert tour",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Bara Pani",
      "Kala Pani",
      "High plateau landscapes",
    ],
    activities: [
      "4x4 safari",
      "Wildlife-aware viewing",
    ...
    travelNote:
      "Use a local 4x4 driver, start early, and keep the day flexible because weather can shift quickly on the plains.",
    keywords: [
    ...
    metaDescription:
      "Deosai National Park safari guide with Sheosar Lake, 4x4 routes, weather, wildlife and Skardu timing. Book now.",
    canonicalPath: "/destinations/deosai-national-park",
    imageAlt:
      "Deosai National Park safari across high plateau and Sheosar Lake Pakistan",
  ...
  },
  {
    ...
    travelNote:
      "Comfortable shoes help because Upper Kachura often includes a short walk from the parking area.",
    keywords: [
      "Shangrila Lake",
      "Upper Kachura",
      "Skardu lakes",
  ...
  },
  {
    ...
    travelNote:
      "Pair Shigar Fort with Sarfaranga for a full day that still returns comfortably to Skardu.",
    keywords: [
    ...
    metaDescription:
      "Shigar Valley Skardu guide to Shigar Fort, Sarfaranga, Balti culture, route timing and day trips. Explore.",
    canonicalPath: "/destinations/shigar-valley",
    imageAlt:
      "Shigar Valley Skardu heritage fort and Karakoram village route Pakistan",
  ...
  },
  {
    ...
    travelNote:
      "Plan fuel, meals, and return timing before leaving Skardu because the drive is long and scenic.",
    keywords: [
      "Khaplu Palace",
      "Ghanche Valley",
      "Balti culture",
  ...
  },
  {
    ...
    travelNote:
      "This route needs permits, guides, porter systems, insurance, gear checks, and buffer days for mountain conditions.",
  ...
  },
  {
    ...
    travelNote:
      "Give Hunza enough nights of its own because combining it with Skardu in too little time turns the route into long transfer days.",
    keywords: [
      "Hunza Valley",
      "Hunza Skardu tour",
      "Attabad Lake",
  ...
  },
  {
    ...
    idealFor: [
      "Repeat visitors",
      "Photographers",
      "Adventure road trippers",
      "Small groups",
    ],
    travelNote:
      "Confirm local access, permits where relevant, and road status before treating this as a fixed route.",
    keywords: [
      "Astore Valley",
      "Rama Meadows",
  ...
  },
  {
    ...
    type: "Alpine lake",
    bestSeason:
      "May to October, with autumn color strongest in September and October",
    image: "/images/places/kachura-lakes.jpg",
    overview:
    ...
    metaDescription:
      "Upper Kachura Lake Skardu guide with boating, village walk, trout lunch, best season and route tips. Visit now.",
    canonicalPath: "/destinations/upper-kachura-lake",
    imageAlt:
      "Upper Kachura Lake Skardu alpine water and mountain village Pakistan",
    ...
    relatedLinks: [
      ...
      {
        label: "Satpara Lake Skardu",
        href: "/destinations/satpara-lake-skardu/",
      },
    ],
  },
  {
    ...
    bestSeason:
      "April to October, with June to September best for Deosai combinations",
    image: "/images/places/deosai-plains.jpg",
    overview:
    ...
    metaDescription:
      "Satpara Lake Skardu guide with Deosai route tips, best season, family stops and lake viewpoints. Explore.",
    canonicalPath: "/destinations/satpara-lake-skardu",
    imageAlt:
      "Satpara Lake Skardu blue mountain water on route to Deosai Pakistan",
...
export function getRelatedDestinations(destination: Destination, limit = 3) {
  return destinations
    .filter(
      (item) =>
        item.slug !== destination.slug && item.type !== destination.type,
    )
    .slice(0, limit);
}
