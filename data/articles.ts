...
const articleSeeds: ArticleSeed[] = [
  {
    ...
    route: "Skardu Airport, Skardu city, Katpana Desert, Shangrila Lake, Upper Kachura, and Shigar",
    ...
    bookingTip: "Book the first night near Skardu city or Katpana Desert so airport pickup, hotel check-in, and sunset plans stay simple.",
  ...
  },
  {
    ...
    secondaryKeywords: ["cold desert Skardu", "Katpana Desert hotels", "Skardu desert tour"],
    intent: "cold desert photography, dunes, sunrise, sunset, nearby hotels, and quick access from the airport",
    route: "Skardu city to Katpana Desert, Katpana Lake, and nearby village roads",
    ...
    bookingTip: "Choose a hotel near Katpana or central Skardu if the desert is your first sunset stop.",
  ...
  },
  {
    ...
    route: "Skardu city, Katpana Desert, airport road, Kachura, and lake-side stays",
  ...
  },
  {
    ...
    secondaryKeywords: ["Katpana Desert hotel booking", "Skardu airport hotels", "desert view hotels Skardu"],
    ...
    localTip: "A hotel that is five minutes closer to Katpana can make sunrise and sunset plans much easier."
  },
  {
  ...
  },
  {
    ...
    route: "Skardu Airport to Katpana Desert, Skardu city hotels, Kachura, and Shigar road",
  ...
  },
  {
    ...
    route: "Day 1 Katpana, Day 2 Kachura, Day 3 Shigar, Day 4 Deosai, Day 5 city and airport",
  ...
  },
  {
    ...
    route: "Skardu, Katpana, Kachura, Shigar, Sarfaranga, Khaplu, Deosai, and Satpara",
  ...
  },
  {
    ...
    route: "Katpana Desert, Shangrila Lake, Upper Kachura, Shigar Fort, and optional Khaplu",
  ...
  },
  {
    ...
    route: "Skardu city, Katpana Desert, Shangrila, Upper Kachura, Satpara, and Shigar Fort",
  ...
  },
  {
    ...
    route: "Skardu city, Kachura, Katpana, Shigar, Deosai, Khaplu, and lower valleys",
  ...
  },
  {
    ...
    route: "Skardu city, Shigar, Kachura, Katpana Desert, and lower valley viewpoints",
  ...
  },
  {
    ...
    route: "Shigar Valley, Kachura, Khaplu, Skardu city, Katpana, and river viewpoints",
  ...
  },
  {
    ...
    secondaryKeywords: ["winter Skardu tour", "snow in Skardu", "Katpana snow desert"],
    intent: "snow travel, cold desert views, heating, flight flexibility, road safety, and winter photography",
    route: "Skardu city, Katpana Desert, Satpara, lower Kachura, and accessible valley roads",
  ...
  },
  {
    ...
    route: "Islamabad Airport to Skardu Airport, then Katpana Desert or Skardu city hotels",
  ...
  },
  {
    ...
    route: "Katpana Desert, Shangrila, Upper Kachura, Satpara, Shigar Fort, Sarfaranga, and Deosai",
  ...
  },
  {
    ...
    route: "Katpana area, Basho, Deosai, Shigar side valleys, and selected lower meadows",
  ...
  },
  {
    ...
    route: "Skardu city base with grouped day trips to Katpana, Kachura, Shigar, and Satpara",
  ...
  },
  {
    ...
    route: "Skardu city, lake resorts, Katpana Desert, Shigar, Khaplu, and selected private viewpoints",
